...
\newcommand{\HRule}{\rule{\linewidth}{2.0mm}}
...
The Berri -- Renmark groundwater model covers the Irrigation Trust Areas of Cobdogla,  Berri and Chaffey (Central Irrigation Trust (CIT)) and the Renmark Irrigation Trust Areas of Renamrk.  Figure \ref{fig01} shows the map of these irrigated districts.
...
\label{fig01}
\caption{Map of the Cobdogla, Berri, Renmark and Chaffey Irrigation Districts}
\end{figure} 

\section{Description of data and methodology}
Two Microsoft Excel\textsuperscript{\textregistered} spreadsheet files were supplied containing the data for irrigated area and consumption (irrigation) volumes and years for which the data was measured or estimated. These data were then transferred to a new spreadsheet that contained templates for calculating the volume of accessions from the application of irrigation water to horticultural crops. Monthly rainfall data for Renmark Irrigation Office (Station ID=024003), Lyrup (Station ID=024008) and Berri (Station ID=24025) were downloaded from the Bureau of Meteorology (URL:\url{http://www.bom.gov.au/climate/data/index.shtml})
...
\subsection{Irrigated Areas}

\subsection{Irrigation Application Volumes}

\subsection{Application Rate}
...
\subsection{Floodplain and Highland}
...
\bibitem[Adams and Meissner(2009)]{Adams2009} Adams, A. and Meissner, T (2009) How Efficient are We. Report prepared for Department For Water by PIRSA Rural Solutions andf Laroona Environmetrics, December 2009.
